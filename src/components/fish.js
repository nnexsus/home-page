            ...
            data-augmented-ui="tl-2-scoop-inset t-round-x tr-2-scoop-inset br-2-scoop-inset b-round-x bl-2-scoop-inset r-round-y l-round-y border">
                <div className='container2'>
                    ...
                    <div className='images' style={{display: 'grid', gridTemplateColumns: '50% 50%', gridTemplateRows: "50% 50%", padding: '50px'}}>
                        <img loading='lazy' title='click to expand' onClick={(e) => onImgClick(e.currentTarget.src)} className='pre-img' pos="1" alt='fish game preview 1' src={'/images/panels/fish/fishgame1.webp'} width="100%" />
                        <img loading='lazy' title='click to expand' onClick={(e) => onImgClick(e.currentTarget.src)} className='pre-img' pos="2" alt='fish game preview 2' src={'/images/panels/fish/fishgame2.webp'} width="100%" />
                        <img loading='lazy' title='click to expand' onClick={(e) => onImgClick(e.currentTarget.src)} className='pre-img' pos="1" alt='fish game preview 3' src={'/images/panels/fish/fishgame3.webp'} width="100%" />
                        <img loading='lazy' title='click to expand' onClick={(e) => onImgClick(e.currentTarget.src)} className='pre-img' pos="2" alt='fish game preview 4' src={'/images/panels/fish/fishgame4.webp'} width="100%" />
                    </div>
                ...
                <button onClick={() => onClick()} className='button'><img loading='lazy' src={'/images/panels/fish/mermaid.png'} style={{width: "70%", marginBottom: "-25px", filter: "drop-shadow(2px 2px 5px lightblue)"}} alt='mermaid'/></button>
            </motion.div>
        </Wrapper>
    )
