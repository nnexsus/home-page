            ...
            <div style={{display: 'flex'}}>
                {favList.map((fav) => (
                    <button className='button-on-bar2' onClick={(e) => setAddBar(e.currentTarget.id)} id={fav} key={fav + Math.random()} style={{display: 'flex', alignItems: 'center', whiteSpace: 'nowrap', overflow: 'hidden'}}>
                        <img alt='decor' width={'15px'} height={'15px'} src='/images/panels/georadio/explorer/Blank sheet.ico' /><p style={{padding: '0', margin: '0', color: 'black'}}>{fav}</p>
                    </button>
                ))}
            </div>
        )
            ...
            style={{backgroundColor: "#C0C7C8", border: "groove 2px"}}>
                <div style={{display: 'grid', gridTemplateColumns: '100%', gridTemplateRows: '25px 21px 3px 13px 40px 27px', overflow: 'hidden'}}>
                    ...
                    <div className='buttons-bar' style={{width: '100%', height: '24px', display: 'flex', alignItems: 'center', gridRow: 4}}>
                        <button title='Home' className='button-on-bar' style={{marginRight: '10px'}}><img alt='decor' onClick={() => setAddBar('http://www.home.com/')} src='images/panels/georadio/explorer/Home.png' width={'20px'} height={'20px'}/></button>
                        ...
                        <button title='Unload' className='button-on-bar'><img alt='decor' onClick={() => setAddBar('')} src='images/panels/georadio/explorer/Shred.png' width={'20px'} height={'20px'}/></button>
                        ...
                        <button title='Cut' className='button-on-bar'><img alt='decor' onClick={() => navigator.clipboard.writeText(addBar)} src='images/panels/georadio/explorer/Cut.png' width={'20px'} height={'20px'}/></button>
                        <button title='Copy' className='button-on-bar'><img alt='decor' onClick={() => navigator.clipboard.writeText(addBar)} src='images/panels/georadio/explorer/Copy.png' width={'20px'} height={'20px'}/></button>
                    ...
                    <div style={{gridRow: 5, display: 'flex', alignItems: 'center', margin: '12px 0 0 0', border: 'inset 3px'}} className='favorite-bar'>
                        <p style={{color: 'black', margin: '0', padding: '0'}}>Favorites:</p><img alt='decor' style={{imageRendering: 'pixelated'}} width={'25px'} height={'25px'} src='/images/panels/georadio/explorer/star.ico' />
                        <FavBar/>
                    </div>
