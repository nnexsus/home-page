        ...
        <Wrapper id='radio'>
            <div style={{backgroundColor: "#C0C7C8", border: "groove 2px"}}>
                ...
                <div className='buttons-bar' style={{width: '100%', height: '24px', display: 'flex', alignItems: 'center', gridRow: 4}}>
                        ...
                        <button title='Upscale Text' className='button-on-bar mobilehide'><img alt='decor' src='images/panels/georadio/explorer/upsize.png' width={'20px'} height={'20px'}/></button>
                        <button title='Downscale Text' className='button-on-bar mobilehide' style={{marginRight: '10px'}}><img alt='decor' src='images/panels/georadio/explorer/downsize.png' width={'20px'} height={'20px'}/></button>
                        <button title='Cut' className='button-on-bar mobilehide'><img alt='decor' src='images/panels/georadio/explorer/Cut.png' width={'20px'} height={'20px'}/></button>
                        <button title='Copy' className='button-on-bar mobilehide'><img alt='decor' src='images/panels/georadio/explorer/Copy.png' width={'20px'} height={'20px'}/></button>
                        <button title='Copy to Clipboard' className='button-on-bar mobilehide' style={{marginRight: '10px'}}><img alt='decor' src='images/panels/georadio/explorer/Paste.png' width={'20px'} height={'20px'}/></button>
                    </div>
                    ...
                    <div id="website" style={{width: '100%', backgroundImage: `url(/images/panels/georadio/tile.jpg)`, paddingTop: '10px'}}>
                        ...
                        <div style={{height: '600px', marginTop: '50px'}}>
                            ...
                            <div style={{textAlign: 'right'}}>
                                <img alt='decor' src='/images/panels/georadio/musica_baile21.gif' width={'150px'} height={'150px'} style={{imageRendering: "pixelated", float: 'left'}}/>
                            ...
                            <img alt='decor' src='/images/panels/georadio/music2.gif' width={'550px'} height={'150px'} style={{imageRendering: "pixelated", float: 'right'}}/>
                        </div>
                    </div>
                </div>
        </div>
