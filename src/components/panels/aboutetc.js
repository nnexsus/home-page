            ...
            <div style={{backgroundColor: "#C0C7C8", border: "groove 2px"}}>
                <div className='top-bar' style={{width: '100%', height: '25px', display: 'flex', backgroundColor: 'darkblue', alignItems: 'center', justifyContent: 'space-between'}}>
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        <img loading='lazy' alt='decor' style={{marginLeft: '5px'}} width="22px" height="22px" src='/images/panels/georadio/Earth (16 colors).ico'/>
                        <h4 className='title' style={{marginLeft: '2px', color: 'white'}}>Internet Explorer</h4>
                    </div>
                ...
                <div className='file-bar content' style={{width: '25%', height: '25px', display: 'flex', alignItems: 'center'}}>
                ...
                <div className='buttons-bar' style={{width: '100%', height: '24px', display: 'flex', alignItems: 'center', gridRow: 4}}>
                        <button title='Open Folder' className='button-on-bar'><img loading='lazy' alt='decor' src='images/panels/georadio/explorer/opendir.png' width={'20px'} height={'20px'}/></button>
                        ...
                        <button title='Upscale Text' className='mobilehide button-on-bar'><img loading='lazy' alt='decor' src='images/panels/georadio/explorer/upsize.png' width={'20px'} height={'20px'}/></button>
                        <button title='Downscale Text' className='mobilehide button-on-bar' style={{marginRight: '10px'}}><img loading='lazy' alt='decor' src='images/panels/georadio/explorer/downsize.png' width={'20px'} height={'20px'}/></button>
                        <button title='Cut' className='mobilehide button-on-bar'><img loading='lazy' alt='decor' src='images/panels/georadio/explorer/Cut.png' width={'20px'} height={'20px'}/></button>
                        <button title='Copy' className='mobilehide button-on-bar'><img loading='lazy' alt='decor' src='images/panels/georadio/explorer/Copy.png' width={'20px'} height={'20px'}/></button>
                        <button title='Copy to Clipboard' className='mobilehide button-on-bar' style={{marginRight: '10px'}}><img loading='lazy' alt='decor' src='images/panels/georadio/explorer/Paste.png' width={'20px'} height={'20px'}/></button>
                    </div>
                ...
                <div className='content' style={{border: 'inset 2px', overflowY: 'scroll', overflowX: 'hidden', height: '1200px', background: 'teal'}}>
                    ...
                    <div id="Home" style={{width: '100%', imageRendering: 'pixelated', padding: '10px', height: '800px'}}>
                        <div className='home-1'>
                            ...
                            <div style={{gridColumn: 2, padding: '10px'}} className='content'>
                                <h1 style={{color: 'black', fontSize: '30px'}}>About Me <i className='mobilehide' style={{fontSize: '20px', color: 'rgba(0,0,0,0.5)'}}>- Scroll down for a twitter preview!</i></h1>
                                ...
                                <div className='aboutButtons'>
                                    <button title='Click to highlight!' className='selector button-on-bar2' id='name' onClick={(e) => onClick(e.currentTarget.id)}><a href='#nnexsus-desc'>Nnexsus</a></button>
                                    <button title='Click to highlight!' className='selector button-on-bar2' id='web' onClick={(e) => onClick(e.currentTarget.id)}><a href='#webdev-desc'>WebDev</a></button>
                                    <button title='Click to highlight!' className='selector button-on-bar2' id='game' onClick={(e) => onClick(e.currentTarget.id)}><a href='#gamedev-desc'>GameDev</a></button>
                                    <button title='Click to highlight!' className='selector button-on-bar2' id='graphic' onClick={(e) => onClick(e.currentTarget.id)}><a href='#graphic-desc'>Graphics</a></button>
                                    <button title='Click to highlight!' className='selector button-on-bar2' id='storm' onClick={(e) => onClick(e.currentTarget.id)}><a href='#storm-desc'>Stormchaser</a></button>
                                </div>
                                    ...
                                    <div className='paragraph-flex'>
                                        <Paragraph id='nnexsus-desc' className='hi-name dark'>
                                            Hello, I'm Ethan. My screen-name is nnexsus (en-nec-sus/ｴﾝ-ﾈｸｿｽ). I'm 20 years old and currently do all sorts of stuff, like coding projects, weather forecasting and storm chasing, video/picture editing, and a lot of IT (it's also my full-time job).
                                        ...
                                        <Paragraph id='webdev-desc' className='hi-web dark'>
                                        ...
                                        <Paragraph id='gamedev-desc' className='hi-game dark'>
                                        ...
                                        <Paragraph id='graphic-desc' className='hi-graphic dark'>
                                        ...
                                        <Paragraph id='storm-desc' className='hi-storm dark'>
                            ...
                            <div style={{gridColumn: 1, height: 'calc(100% - 12px)', background: 'url(/images/panels/about/tile3.jpg)', border: 'inset 3px', padding: '5px'}}>
                                ...
                                <div className='home-3 link-grid'>
                                    <a style={{textShadow: '0px 0px 3px black'}} href='https://twitter.com/_nnexsus'><p>Twitter</p></a>
                                    <a style={{textShadow: '0px 0px 3px black'}} href='https://discord.gg/d8R2tDaBK2'><p>Discord @nnexsus</p></a>
                                    <a style={{textShadow: '0px 0px 3px black'}} href='https://github.com/nnexsus/'><p>Github</p></a>
                                    <a style={{textShadow: '0px 0px 3px black'}} href='https://trello.com/c/6YBXnLYP/'><p>Trello</p></a>
                        ...
                        <div style={{background: 'url(/images/desktop/sitemedia/starbd.gif'}} className='twit-container mobilehide'>
