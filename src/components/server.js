        ...
        <div className='server-container' data-augmented-ui="tl-2-scoop-xy tr-2-scoop-xy br-2-scoop-xy bl-2-scoop-xy both" id='server'>
            ...
            <div className='container'>
                ...
                <div className='container-2'>
                    ...
                    <p style={{background: 'red', color: 'white', textAlign: 'center'}}>Update v2.1 [BISMITE_UPDATE] is out!!</p>
                    ...
                    <h3 style={{color: 'white', textAlign: 'center'}}>Bismite Update Changelog:</h3>
                    <ul style={{listStyle: "square", color: "white", textAlignLast: "left"}}>
                        <li><p style={{color: "lightgreen"}}>Multi-file actions (delete, download, move, etc)!</p></li>
                        <li><p style={{color: "lightgreen"}}>File and folder renaming!</p></li>
                        <li><p style={{color: "lightgreen"}}>New sorting options!</p></li>
                        <li><p style={{color: "lightgreen"}}>Folder and site colors!</p></li>
                    </ul>
                </div>
            </div>
            </div>
